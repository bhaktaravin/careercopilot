      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Card className="border-border/50 bg-card/80 backdrop-blur">
          ...
          <CardContent className="space-y-4">
            <Button variant="outline" className="w-full" onClick={handleGoogle} data-testid="button-google-signin">
          ...
          <CardFooter className="flex justify-center text-sm text-muted-foreground border-t border-border/50 pt-4">
            ...
            <Link href="/sign-up" className="text-primary font-medium hover:underline" data-testid="link-signup">Sign up</Link>
          </CardFooter>
        </Card>
      </div>
    </div>
